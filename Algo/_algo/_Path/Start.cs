public class Start {
    private ComplexityData[] data = {
        ...
        new ComplexityData {levelsCount = 155, complexity = 4, vertexCount = new Pair(56, 63), boardSizes = new []{(8, 10), (10, 8), (9, 9), (11, 8), (10, 9), (9, 10)}}, //80-81-88-90-99, blocks 20-22
    ...
    public static void Main(string[] args) {
        ...
        Console.WriteLine("Has many 1x2 blocks: " + b.HasMany1x2Blocks(t));*/
    }
